...
AS
	SELECT  T1.Stt, T1.Stt0, T1.Ma_Nvu, T1.Ma_Ct, T1.Ngay_Ct, T1.So_Ct, T1.Ma_Tte, T1.Ty_Gia, T1.Ong_Ba, T1.Dien_Giai, '1' AS Loai_Ct, 
			T1.Ma_Kho, T1.Ma_Vt, T1.Dvt, ROUND(T1.So_Luong, 2) AS So_Luong, CAST (0 AS MONEY) AS So_Luong_Cay, CAST (0 AS VARCHAR(10)) AS So_Me, CAST (0 AS VARCHAR(10)) AS Mac_Thep, CAST (0 AS VARCHAR(10)) AS Loai_Phoi, CAST (0 AS MONEY) AS DDai_Phoi, CAST (0 AS VARCHAR(5)) AS Ca_SX, CAST (0 AS BIT) AS Phoi_Ngan,
			...
			T1.Ngay_Ct0, T1.So_Ct0, T1.So_Seri0, CAST(0 AS BIT) AS Auto_Cost, T1.Stt_Org, T1.Ma_DvCs 
		...
		SELECT  T1.Stt, T1.Stt0, T1.Ma_Nvu, T1.Ma_Ct, T1.Ngay_Ct, T1.So_Ct, T1.Ma_Tte, T1.Ty_Gia, T1.Ong_Ba, T1.Dien_Giai, '1' AS Loai_Ct, 
				...
				T1.Ngay_Ct0, T1.So_Ct0, T1.So_Seri0, T1.Auto_Cost, T1.Stt_Org, T1.Ma_DvCs 
		...
		UNION ALL 
		SELECT  T1.Stt, T1.Stt0, T1.Ma_Nvu, T1.Ma_Ct, T1.Ngay_Ct, T1.So_Ct, T1.Ma_Tte, T1.Ty_Gia, T1.Ong_Ba, T1.Dien_Giai, '1' AS Loai_Ct, 
				T1.Ma_Kho, T1.Ma_Vt, T1.Dvt, ROUND(T1.So_Luong, 2) AS So_Luong, ROUND(T1.So_Luong_Cay, 3) AS So_Luong_Cay, So_Me, Mac_Thep, Loai_Phoi, DDai_Phoi, Ca_SX, Phoi_Ngan,
		...
		UNION ALL 
		SELECT  T1.Stt, T1.Stt0, T1.Ma_Nvu, T1.Ma_Ct, T1.Ngay_Ct, T1.So_Ct, T1.Ma_Tte, T1.Ty_Gia, T1.Ong_Ba, T1.Dien_Giai, '2' AS Loai_Ct, 
				T1.Ma_Kho, T1.Ma_Vt, T1.Dvt, T1.So_Luong, ROUND(T1.So_Luong_Cay, 3) AS So_Luong_Cay, So_Me, Mac_Thep, Loai_Phoi, DDai_Phoi, Ca_SX, Phoi_Ngan,
				T1.Gia, ROUND(T1.Tien, 0) AS Tien, CAST(0 AS MONEY) AS Tien3, CAST(0 AS MONEY) AS Tien5, CAST(0 AS MONEY) AS Tien6, 
				T1.Gia_Nt, ROUND(T1.Tien_Nt, 2) AS Tien_Nt, CAST(0 AS MONEY) AS Tien_Nt3, CAST(0 AS MONEY) AS Tien_Nt5, CAST(0 AS MONEY) AS Tien_Nt6, 
				T1.Tk_Co AS Tk, T1.Tk_No, T1.Tk_Co, T1.Ma_Dt, T1.Ma_Vt_Sp, T1.Ma_Bp, T1.Ma_Km, T1.Ma_Hd, T1.Ma_Job, CAST('' AS VARCHAR(20)) AS Ma_Dt_CbNv, CAST('' AS VARCHAR(20)) AS Ma_Kv, CAST('' AS VARCHAR(20)) AS Ma_KhoN, T1.Ma_Kho AS Ma_KhoX, 
				T1.Ngay_Ct0, T1.So_Ct0, T1.So_Seri0, T1.Auto_Cost, T1.Stt_Org, T1.Ma_DvCs 
		...
		SELECT  T1.Stt, T1.Stt0, T1.Ma_Nvu, T1.Ma_Ct, T1.Ngay_Ct, T1.So_Ct, T1.Ma_Tte, T1.Ty_Gia, T1.Ong_Ba, T1.Dien_Giai, '1' AS Loai_Ct, 
				T1.Ma_KhoN AS Ma_Kho, T1.Ma_Vt, T1.Dvt, ROUND(T1.So_Luong, 0) AS So_Luong, ROUND(T1.So_Luong_Cay, 3) AS So_Luong_Cay, So_Me, Mac_Thep, Loai_Phoi, DDai_Phoi, Ca_SX, Phoi_Ngan,
				T1.Gia, ROUND(T1.Tien, 0) AS Tien, CAST(0 AS MONEY) AS Tien3, CAST(0 AS MONEY) AS Tien5, CAST(0 AS MONEY) AS Tien6, 
				T1.Gia_Nt, ROUND(T1.Tien_Nt, 2) AS Tien_Nt, CAST(0 AS MONEY) AS Tien_Nt3, CAST(0 AS MONEY) AS Tien_Nt5, CAST(0 AS MONEY) AS Tien_Nt6, 
		...
		SELECT  T1.Stt, 999 AS Stt0, T2.Ma_Nvu, T1.Ma_Ct, T1.Ngay_Ct, T1.So_Ct, T2.Ma_Tte, T2.Ty_Gia, T2.Ong_Ba, T2.Dien_Giai, '1' AS Loai_Ct, 
				...
				T2.Ngay_Ct0, T2.So_Ct0, T2.So_Seri0, CAST(0 AS BIT) AS Auto_Cost, T2.Stt_Org, T2.Ma_DvCs 
