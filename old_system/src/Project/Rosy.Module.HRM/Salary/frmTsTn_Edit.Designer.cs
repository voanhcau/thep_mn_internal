namespace RosyModule.Salary
{
	partial class frmTsTn_Edit
	{
		...
		private void InitializeComponent()
		{
			...
			this.numMuc_Ap = new RosySystem.Control.rsTextBoxNumber();
			...
			this.rsLabel1.Tag = "Muc_Ap";
			this.rsLabel1.Text = "Mức áp";
			...
			this.numMuc_Ap.Location = new System.Drawing.Point(127, 68);
		...
		private RosySystem.Control.rsTextBoxNumber numMuc_Ap;
