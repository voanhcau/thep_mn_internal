...
{
	public partial class frmChamCongNT : RosySystem.Customize.frmView
	{
		...
		new public void Load()
		{
            ...
            Voucher.LoadComboBpNT((rsMultiComboBox)cboMa_Bp);
            ...
            if((!Common.Inlist(strMa_Bp, "NQL,PTCHC") && !Element.sysIs_Admin))
            {
                ...
                cboMa_Bp.Text = "PCNTT";
            else if (Common.Inlist(strMa_Bp, "NQL,PTCHC,PCNTT"))
            {
                cboMa_Bp.Text = "PTCHC";
		...
		private void FillData()
		{
            ...
            dsChamCong = SQLExec.ExecuteReturnDs("sp_GetChamCongNT", ht, CommandType.StoredProcedure);
            ...
            dtTHChamCong = dsChamCong.Tables[5];
        ...
        bool PrintCC(bool bPreview, string strMa_Dt_CbNv)
        {
            ...
            DataSet ds = SQLExec.ExecuteReturnDs("sp_PrintChamCongNT", ht, CommandType.StoredProcedure);
        ...
        void cboMa_Bp_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dsBp = SQLExec.ExecuteReturnDs("sp_GetBpLuongNT", ht, CommandType.StoredProcedure);
            
                dtDmBpCt = dsBp.Tables[0];
