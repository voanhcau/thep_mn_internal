...
{
	public partial class frmCtHD_Bk_Edit : frmVoucher_Edit
	{
		#region Declare
		...
		void txtMa_Kho_Xuat_Validating(object sender, CancelEventArgs e)
		{
			...
			if (drLookup == null)
			{
				...
				lbtTen_Kho_Xuat.Text = string.Empty;
			}
			else
			{
				txtMa_Kho_CalGia.Text = drLookup["Ma_Kho"].ToString();
				txtMa_Kho_CalGia.Text = drLookup["Ma_Kho"].ToString();
				lbtTen_Kho_Xuat.Text = drLookup["Ten_Kho"].ToString();
			}
