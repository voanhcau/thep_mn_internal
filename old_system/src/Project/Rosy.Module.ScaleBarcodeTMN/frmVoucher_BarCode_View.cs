...
{
	public partial class frmVoucher_BarCode_View : RosySystem.Customize.frmView
	{
		#region Fields
        ...
        public frmVoucher_BarCode_View()
		{
			InitializeComponent();
		...
		private void FillData(DataRow drFilter)
		{
            ...
            dsVoucher = SQLExec.ExecuteReturnDs("sp_GetVoucher_BarCode_KKV", drFilter, CommandType.StoredProcedure);
		...
		public override void Edit(enuEdit enuNew_Edit)
		{
            ...
            frmVoucher_BarCode_Edit frmEdit = (frmVoucher_BarCode_Edit)Activator.CreateInstance(type);
