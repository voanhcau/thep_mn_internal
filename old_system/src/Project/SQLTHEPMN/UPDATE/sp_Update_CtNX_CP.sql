...
/*
DROP PROCEDURE Sp_Update_CtNX_CP

--Tạo lại TVP
EXEC sp_CreateTVPStructure 'R80PH', 'TVP_PHNX_CP', 1
EXEC sp_CreateTVPStructure 'R05CtNX_CP', 'TVP_CtNX_CP', 1
...
*/
IF OBJECT_ID('Sp_Update_CtNX_CP') IS NOT NULL DROP PROCEDURE Sp_Update_CTNX_CP
GO 

CREATE PROCEDURE [dbo].[Sp_Update_CtNX_CP]
(
	@strNew_Edit CHAR(1),
	@PH TVP_PHNX_CP READONLY,
	@Ct TVP_CtNX_CP READONLY,
	@Stt VARCHAR(15),
	@Ma_Ct VARCHAR(5),
	@Ma_DvCs VARCHAR(5)
)
...
BEGIN
	...
	SELECT	@_TVPPHName = 'TVP_PHNX_CP',
			@_TVPCtName = 'TVP_CtNX_CP'
