/*
DROP PROCEDURE Sp_Update_CtBRem

--Tạo lại TVP
EXEC sp_CreateTVPStructure 'R80PH', 'TVP_PHBREM', 1
EXEC sp_CreateTVPStructure 'R03CtBRem', 'TVP_CtBREM', 1
...
*/
IF OBJECT_ID('Sp_Update_CtBREM') IS NOT NULL DROP PROCEDURE Sp_Update_CtBREM
GO 

CREATE PROCEDURE [dbo].[Sp_Update_CtBREM]
(
	@strNew_Edit CHAR(1),
	@PH TVP_PHBREM READONLY,
	@Ct TVP_CtBREM READONLY,
	@Stt VARCHAR(15),
	@Ma_Ct VARCHAR(5),
	@Ma_DvCs VARCHAR(5)
)
...
BEGIN
	...
	SELECT	@_TVPPHName = 'TVP_PHBREM',
			@_TVPCtName = 'TVP_CtBREM'
