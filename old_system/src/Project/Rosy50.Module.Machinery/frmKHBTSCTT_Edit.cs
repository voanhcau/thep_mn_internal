...
{
	public partial class frmKHBTSCTT_Edit : RosySystem.Customize.frmEdit
	{
		public frmKHBTSCTT_Edit()
		{
			InitializeComponent();
		...
		public void load(enuEdit enuNew_Edit, DataRow drEdit)
		{
			...
			if ((string)drEdit["Loai_Ke_Hoach"] == "Kiểm tra")
			{
				rdbKiem_Tra.Checked = true;
			}
			else
			{
				rdbSua_Chua.Checked = true;
			}
		...
		private bool Save()
		{
			...
			drEdit["KIEM_TRA"] = rdbKiem_Tra.Checked;
			drEdit["SUA_CHUA"] = rdbSua_Chua.Checked;
            drEdit["LOAI_KE_HOACH"] = rdbKiem_Tra.Checked ? "Kiểm tra" : "Sửa chữa";
