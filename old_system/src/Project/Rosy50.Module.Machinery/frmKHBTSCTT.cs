...
{
	public partial class frmKHBTSCTT : RosySystem.Customize.frmView
	{
		#region variable
		...
		void dgvKHBTSC_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
		{
			...
			if (strColumnName.ToUpper() == "DUYET_KT")
			{
				...
				frm.Load(drCurrent, "Kiểm tra, Sửa chữa");
		...
		private void Build()
		{
			...
			dgvKHBTSC.strZone = "KHBTSCTT";
			dgvKHBTSC.BuildGridView(this.isLookup);

			this.rsSplitContainer1.Panel1.Controls.Add(dgvKHBTSC);
		...
		public override void Edit(enuEdit enuNew_Edit)
		{
			...
			frmKHBTSCTT_Edit frmKHBTSC_Edit = new frmKHBTSCTT_Edit();
