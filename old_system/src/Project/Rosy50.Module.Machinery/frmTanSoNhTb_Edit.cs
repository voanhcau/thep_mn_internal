...
{
    public partial class frmTanSoNhTb_Edit : RosySystem.Customize.frmEdit
    {
        public frmTanSoNhTb_Edit()
        {
            InitializeComponent();
        ...
        private void LoadDicName()
        {
            ...
            {
                lbtTen_Tb.Text = DataTool.SQLGetNameByCode("R06DMNHTB", "Ma_Nh_Tb", "Ten_Nh_Tb", txtMa_Nh_Tb.Text.Trim());
            }
            else
        ...
        public bool Save()
        {
            ...
            if (!DataTool.SQLUpdate(enuNew_Edit, "R06TSNHTB", ref drEdit))
                return false;
