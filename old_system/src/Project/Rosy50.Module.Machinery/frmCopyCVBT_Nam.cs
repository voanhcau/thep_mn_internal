...
{
    public partial class frmCopyCVBT_Nam : RosySystem.Customize.frmView
	{
		#region variable
		...
		public void Load()
		{
            ...
            numNam_Copy.Value = Element.sysWorkingYear + 1;
		...
		{       
            ...
            dtDmVt = SQLExec.ExecuteReturnDt("sp_GetCopyBTTB_Nam", ht, CommandType.StoredProcedure);
        ...
        {           
            ...
            DataTable dtCopy = DataTool.SQLGetDataTable("R06KHBTTB", "*", "0=1", "");
        ...
        void Save(DataTable dtImport)
        {
            ...
            sqlCom.Parameters.AddWithValue("@NAM", numNam_Copy.Value);
            sqlCom.Parameters.AddWithValue("@COPY_VT", chkCopy_Vt.Checked);
            ...
            sqlCom.CommandText = "sp_CopyCVBTTB_Nam";
            //sp_Update_KHVTPT

            //TVP_CT
            paraCt.TypeName = "TVP_KHBTTB";
            paraCt.Value = Voucher.GetTVPValue("R06KHBTTB", "TVP_KHBTTB", dtImport);
