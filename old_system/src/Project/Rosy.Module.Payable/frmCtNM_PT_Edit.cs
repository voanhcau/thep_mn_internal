...
{
	public partial class frmCtNM_PT_Edit : frmVoucher_Edit
	{
		...
		public override void Load(enuEdit enuNew_Edit, DataRow drEdit, DataSet dsVoucher)
		{
			...
			if (this.enuNew_Edit == enuEdit.New && strMa_Ct == "NMHH")
			{
		...
		{
			if (this.ActiveControl == txtSo_Ct && strMa_Ct == "NMHH")
			{
				txtSo_Ct0.Text = txtSo_Ct.Text;
				dteNgay_Ct0.Text = dteNgay_Ct.Text;
			}
