namespace RosyList
{
	partial class frmDmCoTinh
	{
		...
		private void InitializeComponent()
		{
			...
			// btImport
			// 
			this.btImport.Location = new System.Drawing.Point(316, 3);
			// 
			// frmDmCoTinh
			// 
			...
			this.Name = "frmDmCoTinh";
			this.Object_ID = "DMCOTINH";
			this.Tag = "frmDmCoTinh";
			this.Text = "frmDmCoTinh";
