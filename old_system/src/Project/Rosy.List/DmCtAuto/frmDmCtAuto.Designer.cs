namespace RosyList
{
	partial class frmDmCtAuto
	{
		...
		private void InitializeComponent()
		{
			...
			this.splitcContent.SplitterDistance = 503;
			// 
			// btImport
			// 
			this.btImport.Location = new System.Drawing.Point(340, 8);
			// 
			// frmDmCtAuto
			// 
			...
			this.Name = "frmDmCtAuto";
			this.Object_ID = "DMCTAUTO";
			this.Tag = "frmDmCtAuto";
			this.Text = "frmDmCtAuto";
