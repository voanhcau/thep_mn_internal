...
{
	partial class frmBangKTTauHangGD
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.numKL_TC = new RosySystem.Control.rsTextBoxNumber();
			...
			this.txtTg_Cap_Ben = new RosySystem.Control.rsTextBox();
			this.rsLabel5 = new RosySystem.Control.rsLabel();
			this.txtTg_Lam_Hang = new RosySystem.Control.rsTextBox();
			...
			this.splitContainer.Panel2.Controls.Add(this.numKL_TC);
			...
			this.splitContainer.Size = new System.Drawing.Size(827, 475);
			...
			this.splitContainer1.Panel1.Controls.Add(this.txtTg_Lam_Hang);
			this.splitContainer1.Panel1.Controls.Add(this.rsLabel4);
			this.splitContainer1.Panel1.Controls.Add(this.txtTg_Cap_Ben);
			...
			this.txtMa_Dt.Location = new System.Drawing.Point(172, 33);
			...
			this.lbtTen_Hd.Location = new System.Drawing.Point(297, 15);
			...
			this.lblMa_Hd.Location = new System.Drawing.Point(69, 14);
			...
			this.lblMa_Dt.Location = new System.Drawing.Point(69, 36);
			...
			this.txtMa_Hd.Location = new System.Drawing.Point(172, 11);
			...
			this.lbtTen_Dt.Location = new System.Drawing.Point(297, 37);
			...
			this.dgvKQKN.Size = new System.Drawing.Size(827, 240);
			this.dgvKQKN.strZone = "";
			this.dgvKQKN.TabIndex = 3;
			// 
			// rsLabel3
			// 
			...
			this.rsLabel3.Location = new System.Drawing.Point(369, 75);
			this.rsLabel3.Name = "rsLabel3";
			this.rsLabel3.Size = new System.Drawing.Size(74, 13);
			this.rsLabel3.TabIndex = 289;
			this.rsLabel3.Text = "Tổng tạp chất";
			this.rsLabel3.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// numKL_TC
			// 
			this.numKL_TC.BackColor = System.Drawing.SystemColors.Window;
			this.numKL_TC.bFormat = true;
			this.numKL_TC.Location = new System.Drawing.Point(458, 72);
			this.numKL_TC.Margin = new System.Windows.Forms.Padding(2, 0, 2, 2);
			this.numKL_TC.Name = "numKL_TC";
			this.numKL_TC.ReadOnly = true;
			this.numKL_TC.Scale = 2;
			this.numKL_TC.Size = new System.Drawing.Size(120, 20);
			this.numKL_TC.TabIndex = 288;
			this.numKL_TC.Tag = "Tien_No0";
			this.numKL_TC.Text = "0.00";
			this.numKL_TC.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.numKL_TC.Value = 0D;
			// 
			// rsLabel2
			// 
			...
			this.rsLabel2.Location = new System.Drawing.Point(369, 53);
			...
			this.numHMS2.Location = new System.Drawing.Point(458, 50);
			...
			this.rsLabel1.Location = new System.Drawing.Point(369, 31);
			...
			this.numHMS1.Location = new System.Drawing.Point(458, 28);
			...
			this.rsLabel85.Location = new System.Drawing.Point(88, 31);
			...
			this.numSo_Luong.Location = new System.Drawing.Point(241, 28);
			...
			this.btgAccept.Location = new System.Drawing.Point(634, 50);
			...
			this.rsLabel4.Location = new System.Drawing.Point(69, 58);
			this.rsLabel4.Name = "rsLabel4";
			this.rsLabel4.Size = new System.Drawing.Size(93, 13);
			this.rsLabel4.TabIndex = 66;
			this.rsLabel4.Tag = "";
			this.rsLabel4.Text = "Thời giàn cập cầu";
			this.rsLabel4.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// txtTg_Cap_Ben
			// 
			this.txtTg_Cap_Ben.BackColor = System.Drawing.SystemColors.Window;
			this.txtTg_Cap_Ben.Location = new System.Drawing.Point(172, 55);
			this.txtTg_Cap_Ben.Margin = new System.Windows.Forms.Padding(2, 0, 2, 2);
			this.txtTg_Cap_Ben.MaxLength = 200;
			this.txtTg_Cap_Ben.Name = "txtTg_Cap_Ben";
			this.txtTg_Cap_Ben.Size = new System.Drawing.Size(415, 20);
			this.txtTg_Cap_Ben.TabIndex = 1;
			// 
			// rsLabel5
			// 
			this.rsLabel5.AutoEllipsis = true;
			this.rsLabel5.AutoSize = true;
			this.rsLabel5.Location = new System.Drawing.Point(69, 80);
			this.rsLabel5.Name = "rsLabel5";
			this.rsLabel5.Size = new System.Drawing.Size(97, 13);
			this.rsLabel5.TabIndex = 68;
			this.rsLabel5.Tag = "";
			this.rsLabel5.Text = "Thời gian làm hàng";
			this.rsLabel5.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// txtTg_Lam_Hang
			// 
			this.txtTg_Lam_Hang.BackColor = System.Drawing.SystemColors.Window;
			this.txtTg_Lam_Hang.Location = new System.Drawing.Point(172, 77);
			this.txtTg_Lam_Hang.Margin = new System.Windows.Forms.Padding(2, 0, 2, 2);
			this.txtTg_Lam_Hang.MaxLength = 200;
			this.txtTg_Lam_Hang.Name = "txtTg_Lam_Hang";
			this.txtTg_Lam_Hang.Size = new System.Drawing.Size(415, 20);
			this.txtTg_Lam_Hang.TabIndex = 2;
			// 
			// frmBangKTTauHangGD
			// 
			...
			this.Name = "frmBangKTTauHangGD";
			this.Text = "frmBangKQKiemTraGD";
		...
		private RosySystem.Control.rsTextBoxNumber numKL_TC;
		private RosySystem.Control.rsLabel rsLabel5;
		private RosySystem.Control.rsTextBox txtTg_Lam_Hang;
		private RosySystem.Control.rsLabel rsLabel4;
		private RosySystem.Control.rsTextBox txtTg_Cap_Ben;
    }
}