...
{
	public partial class frmInherit_LXHKKV : RosySystem.Customize.frmView
	{
		#region Declare
        ...
        new public void Load(string strMa_Vt, string strMa_Kho)
		{
        ...
        new public void Load(string strMa_Kho)
        {
            this.strMa_Kho = strMa_Kho;
            dteNgay_Ct1.Text = dteNgay_Ct2.Text = Library.DateToStr(Element.sysNgay_Ct2);
            this.Build();
		...
		void FillData()
		{
            ...
            ht.Add("MA_KHO", strMa_Kho);
            ht.Add("IS_INHERIT", chkInheritedExcept.Checked);
            dtInheritVoucher = SQLExec.ExecuteReturnDt("sp_GetInheritLXHKKVBarcodeLe", ht, CommandType.StoredProcedure);
