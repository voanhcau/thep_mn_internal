...
{
	public partial class frmInherit_LCAN : RosySystem.Customize.frmView
	{
		#region Declare
		...
		void Build()
		{
			dgvInheritVoucher.strZone = "INHERIT_PCAN_PNM";
		...
		void FillData()
		{
            ...
            ht.Add("MA_VT_LIST", txtMa_Vt_Sp.Text);
            //ht.Add("IS_INHERIT", chkInheritedExcept.Checked);
            dtInheritVoucher = SQLExec.ExecuteReturnDt("sp_GetInheritPCANPNM", ht, CommandType.StoredProcedure);
